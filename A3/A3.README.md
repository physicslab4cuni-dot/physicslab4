...
- Alternatively, upload the files to the `A3` folder where the notebook file `A3.ipynb` is located. Then, use the following syntax to include the image in a markdown cell:
```markdown
